	...
	if ($_POST['captcha'] == "dudule") {
		...
		$body .= "L'equipe de " . SITENAMELONG;
		  ...
		  //mise à jour BD avec le nouveau mot de passe utilisateur
    		...
    		header("Location: recup_pass.php?action=wrongcaptcha");
	}
    }
?>
	...
	<div class="container bg-light py-2 px-3 small">
		<form class="form-group" action='' method='post'>
			...
			<div class="form-group">
    				<label for="captcha"><i class="fas fa-mail-bulk"></i> Anti-spam : Recopiez le mot <b>dudule</b><br>
