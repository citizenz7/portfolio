...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 17 juil. 2020 à 08:45
...
(1, 'olivier', '$2y$10$BCTiZDkAcHfCFv6w.MC3iOKiVptExwC1y2KaW4ymXcylKdsTlhraa', 'contact@olivierprieur.fr'),
(2, 'citizenz', '$2y$10$k3S2uSBySDjuI.Nbhewkpe.iaOnA7aYEVfqgkueu8DgaAdsxGMQCy', 'citizenz7@protonmail.com');
...
(3, 'Portfolio PHP/MySQL', 'HTML / CSS / PHP / MySQL', 'php', '<p>Projet de cr&eacute;ation d\'un portfolio avec backend PHP / MySQL dans le cadre de l\'Access Code School de Nevers.</p>', 'https://github.com/citizenz7/portfolio', '2020-07-16 13:25:19', 'img/projets/projet3-portfolio.jpg', 1),
...
(6, 'Ceci est un test', 'HTML, CSS', 'html', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>', NULL, '2020-07-15 16:50:24', 'img/projets/projet-test-2.png', 15);
COMMIT;
